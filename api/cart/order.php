...
$sql1 = "insert into chayam_orders_detail( ";
...
$sql1 .= " from chayam_cart t1 where t1.u_id = '$s_id';"; 

// 기존 장바구니 내역 삭제
$sql2 = "delete from chayam_cart where u_id = '$s_id' ";
...
$count_sql .= "        FROM ";
$count_sql .= "            chayam_orders_detail x1 ";
$count_sql .= "        where ";
...
// 이전에 주문이력이 있을 경우
$sql3 = "update chayam_stamp set ";
$sql3 .= "count = count + $count_sql ";
$sql3 .= "where u_id = '$s_id'; ";

// 최초 주문일 때 stamp 찍기
$sql4 = "insert into chayam_stamp ( ";
$sql4 .= "    u_id, ";
$sql4 .= "    count ";
$sql4 .= ") ";
$sql4 .= "select ";
